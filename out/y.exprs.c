...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from exprs.yacc  */
...
const int YY_parse_CLASS::TOKHEAT=259;
const int YY_parse_CLASS::STATE=260;
const int YY_parse_CLASS::TOKTARGET=261;
const int YY_parse_CLASS::TOKTEMPERATURE=262;
const int YY_parse_CLASS::start_prog=263;
